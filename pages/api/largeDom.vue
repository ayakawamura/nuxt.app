<script setup>
import CouponApiDomComp from '~/components/CouponApiDomComp.vue'
import BackButton from '~/components/parts/BackButton.vue'
import AddressPanelApiDomComp from '~/components/AddressPanelApiDomComp.vue';
...
<template>
  <div id="sysMain">
    ...
    <div class="deliveryAddress">
      ...
      <!-- お届け先リスト -->
      <AddressPanelApiDomComp />


    </div>

    <!-- クーポン設定 -->
    <CouponApiDomComp apiLink="large"/>
